...
export const sendVerficationEmail = async (recipientEmail, code) => {
    try {
        const mailOptions = {
            from: 'UAuth <uauth.authentication@gmail.com>',
            to: recipientEmail,
...
export const sendForgotPasswordEmail = async (recipientEmail, resetPasswordPageURL) => {
    try {
        const mailOptions = {
            from: 'UAuth <uauth.authentication@gmail.com>',
            to: recipientEmail,
